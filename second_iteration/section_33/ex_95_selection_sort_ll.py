...
class LinkedList:
    ...
    def selection_sort(self):
        ...
        for _ in range(self.length - 1):
            to_be_changed = to_be_changed.next
            
            smallest = to_be_changed
            ...
            if smallest is not to_be_changed:
                to_be_changed.value, smallest.value = smallest.value, to_be_changed.value
